...
def google_login_button(label: str = "Continue with Google") -> dict | None:
    ...
    revoke_url = "https://oauth2.googleapis.com/revoke"  # Not used to avoid auth method requirement
    ...
    # Avoid passing revoke_token_endpoint to prevent MissingRevokeTokenAuthMethodError on certain httpx-oauth versions
